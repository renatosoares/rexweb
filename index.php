...
<html lang="en">
  <head>
    ...
    <title>RexTech Soluções Tecnologicas</title>
    ...
    <link rel="stylesheet" type="text/css" href="assets/bootstrap-material/css/bootstrap-material-design.min.css">
    <link rel="stylesheet" type="text/css" href="assets/bootstrap-material/css/ripples.min.css">
  ...
  ================================================== -->
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
          <img class="third-slide" src="assets/img/banner11.jpg" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
    ...
    <main class="container">
      ...
      <section class="row">
        ...
        <article class="col-sm-8">
          <img src="assets/img/img1.png" class="img-responsive">
        </article>
      </section>
